...
/*Fragment del menú del minijuego 3*/
public class MazeMenuFragment extends BaseFragment {
    ...
    public MazeMenuFragment(){}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState){
        View root = inflater.inflate(R.layout.fragment_maze_menu, container, false);
        loadColors(root);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        gameTitle = (TextView) view.findViewById(R.id.placeholderView5);
        gameDesc = (TextView) view.findViewById(R.id.placeholderView6);
    ...
    private void startGame(){
        if (getMainActivity().getVirtualPetManager().getPlayPoints() > 0) {
            ...
            Fragment gameFragment = new MazeGameFragment();
