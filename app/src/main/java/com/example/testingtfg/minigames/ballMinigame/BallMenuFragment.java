...
/*Fragment del menú del minijuego 2*/
public class BallMenuFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_glass_menu, container, false);
        loadColors(root);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        gameTitle = (TextView) view.findViewById(R.id.placeholderView3);
        gameDesc = (TextView) view.findViewById(R.id.placeholderView4);
        ...
        buttonStart = (Button) view.findViewById(R.id.maze_btn_start);
        ...
        buttonGoBack = (Button) view.findViewById(R.id.maze_btn_close);
    ...
    private void startGame(){
        if (getMainActivity().getVirtualPetManager().getPlayPoints() > 0) {
            ...
            Fragment gameFragment = new BallGameFragment();
